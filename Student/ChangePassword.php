...
if(isset($_POST['passsubmit'])){
  ...
  if($num>0 && $newpass==$conpass){
      ...
      $_SESSION['spwmsg'] = "Password Changed Successfully";
      header("refresh:2;url=ChangePassword.php");
  }else{
      $_SESSION['spwmsg'] = "Password does not match";
      header("refresh:2;url=ChangePassword.php");
  }
}
?>
...
<head>
  ...
  <link rel="stylesheet" href="stuindex.css" />
  ...
  <?php include('./includes/sidebar.php')?>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid password py-2">
        <p style="color:blue;"><?php echo $_SESSION['spwmsg'];?><?php $_SESSION['spwmsg']="";?></p>
